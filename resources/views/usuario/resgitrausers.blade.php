                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-l es-p20t es-p15b es-p30r es-p30l" bgcolor="#ffffff" align="left">
                                                                                        <p>#Has registro un nuevo usuario con éxito.<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                        <table style="border-radius: 4px; border-collapse: separate; background-color: #FFFFFF;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-l es-p35t es-p30r es-p30l" bgcolor="#FFFFFF" align="left">
                                                                                        <p>Información&nbsp; quien&nbsp; has&nbsp; registrado&nbsp;  fue&nbsp;<span style="color:#111111;">  {{$nombre}}   {{$apellido}} </span>
                                        ...
                                        <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; margin: 0 auto; padding: 0; width: 570px;" bgcolor="#FFFFFF">
                                            ...
                                            <tr>
                                              <td class="content-cell" style="box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; padding: 35px; word-break: break-word;">
                                                ...
                                                Por razones de seguridad, esta solicitud se
                                                recibió de un dispositivo {{$plataforma}}
                                                usando {{$navegado}}. Si otra persona esta
                                                 usando su usuario cerrer toda la sesión o póngase en
