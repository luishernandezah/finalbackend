                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-l es-p20t es-p15b es-p30r es-p30l" bgcolor="#ffffff" align="left">
                                                                                        <p>Has registrado un nuevo préstamo con éxito.<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-l es-p35t es-p30r es-p30l" bgcolor="#111111" align="left">
                                                                                        <h2 style="color: #FFFFFF;">Información a quien has prestado fue a : {{$nombre}} {{$apellido}}<br></h2>
                                                                                    </td>
                                                                                </tr>
                                                                                  <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p>Préstamo&nbsp;<span style="color:#111111;">{{$empreta}}</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p>Total&nbsp; a&nbsp;  pagar&nbsp;<span style="color:#111111;"> {{$totalapagar}}</span>
                                                                                    </td>
                                                                                </tr>
