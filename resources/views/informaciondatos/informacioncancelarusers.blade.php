                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-l es-p20t es-p15b es-p30r es-p30l" bgcolor="#ffffff" align="left">
                                                                                        <p>Has finalizado un  préstamo con éxito.<br></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="540" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p40t es-p40b es-p10r es-p10l" align="center"><span class="es-button-border" style="background: #ec6d64 none repeat scroll 0% 0%; border-color: #ec6d64;"><a href="{{$url}}" class="es-button" target="_blank" style="border-width: 15px 25px; background: #ec6d64 none repeat scroll 0% 0%; border-color: #ec6d64;">ENTRAR PÁGINA</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                        <table style="border-radius: 4px; border-collapse: separate; background-color: #FFFFFF;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-m-txt-l es-p35t es-p30r es-p30l" bgcolor="#111111" align="left">
                                                                                        <h2 style="color: #FFFFFF;">Usuario finalizo su pago: {{$nombre}} {{$apellido}}<br></h2>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p>Tu Préstamo es:&nbsp;<span style="color:#111111;"> {{$empreta}}</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p>Total a pagar:&nbsp;<span style="color:#111111;">  {{$total}}</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p>Tu abono  fue:&nbsp;<span style="color:#111111;"> {{$abono}}</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p20t es-p30r es-p30l es-m-txt-l" align="left">
                                                                                        <p>Tu descuesto  fue:&nbsp;<span style="color:#111111;"> {{$resta}}</span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                              ...
                                              <td class="content-cell" style="box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; padding: 35px; word-break: break-word;">
                                                ...
                                                <p style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;" align="left">
                                                    ...
                                                    {{$plataforma}} usando {{$navegado}}.
                                                     Si otra persona esta usando su usuario cerrer toda la sesión o póngase en
