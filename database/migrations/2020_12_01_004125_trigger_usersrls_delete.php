...
class TriggerUsersrlsDelete extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trigger_usersrls_delete', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trigger_usersrls_delete');
    }
}
