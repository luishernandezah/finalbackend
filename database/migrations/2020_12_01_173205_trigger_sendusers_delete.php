...
class TriggerSendusersDelete extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trigger_sendusers_delete', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trigger_sendusers_delete');
    }
}
