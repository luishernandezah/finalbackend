...
class TriggerUsersregistyInsert extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trigger_usersregisty_insert', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trigger_usersregisty_insert');
    }
}
