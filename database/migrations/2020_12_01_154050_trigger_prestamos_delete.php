...
class TriggerPrestamosDelete extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trigger_prestamos_delete', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trigger_prestamos_delete');
    }
}
