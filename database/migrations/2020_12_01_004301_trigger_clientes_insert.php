...
class TriggerClientesInsert extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trigger_clientes_insert', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('trigger_clientes_insert');
    }
}
